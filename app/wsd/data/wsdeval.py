...
DATA_ROOT = Path("data/WSD_Evaluation_Framework/Evaluation_Datasets")


class Variant(Enum):
    ALL = "ALL/ALL.{dataset}"
    SEMEVAL2007 = "semeval2007/semeval2007.{dataset}"
    SEMEVAL2013 = "semeval2013/semeval2013.{dataset}"
    SEMEVAL2015 = "semeval2015/semeval2015.{dataset}"
    SENSEVAL2 = "senseval2/senseval2.{dataset}"
    SENESVAL3 = "senseval3/senseval3.{dataset}"
